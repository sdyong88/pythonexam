...
CREATE TABLE `favorites` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_favorites_qoutes1_idx` (`qoute_id`),
  KEY `fk_favorites_users1_idx` (`user_id`),
  CONSTRAINT `fk_favorites_qoutes1` FOREIGN KEY (`qoute_id`) REFERENCES `qoutes` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `favorites` VALUES (5,4,1),(6,5,1),(8,5,2),(9,4,2),(10,5,2);
